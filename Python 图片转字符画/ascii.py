...
ascii_char_71 = list("$@B%8&WM#*oahkbdpqwmZO0QLCJUYXzcvunxrjft/\|()1{}[]?-_+~<>i!lI;:,\"^`'. ")
ascii_char_88 = list("1234567890~!@#$%^&*()_+qwertyuiopasdfghjklzxcvbnmQWERTYUIOPASDFGHJKLZXCVBNM[]{};:',<.>/?")
ascii_char_1 = list(" 01")
...
if __name__ == '__main__':
    ...
    if OUTPUT:
        ...
        with open("output_xuejie.txt", 'w') as f:
            f.write(txt)
